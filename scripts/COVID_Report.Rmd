...
qc_csv$depth=vapply(strsplit(as.character(qc_csv$X1X_coverage_after_trimming),"[.]"), 
                     `[`, 1, FUN.VALUE=character(1))
...
- Pangolin version: 4.3.1-pdata-1.23.1
- Nextclade version: 3.0.0-alpha.0
- Cecret version: 3.10.20231205
